...
import { SIMULATION_SIZE_Y, SEGMENTS, VELOCIDAD_SONIDO } from '../constants.js';
...
export const AudioWaveVisualizer = ({
  ...
  const labelFreqRef = useRef(null);
  const labelDistanciaRef = useRef(null);
  const startTimeRef = useRef(performance.now()); // Para el uniforme de tiempo
    ...
    const material = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
          ...
          void main() {
              ...
              // NUEVA LÓGICA DE COLOR PARA VERDE CLARO Y ROJO INTENSO
              ...
              vec3 lighter_green = mix(u_green_color, vec3(1.0, 1.0, 1.0), power_static * 0.3); // Blend green with white
              vec3 intense_red = mix(u_red_color, u_red_color * 1.5, 1.0 - power_static); // Intensify red
